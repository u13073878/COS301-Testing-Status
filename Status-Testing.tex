...
The code for the unit tests is given by the figure below. For the test, NodeUnit was used.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.0\textwidth]{LaTeX/Figures/activateAppraisalTypeUnitTests.png}
...
The following was the output given by NodeUnit.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{LaTeX/Figures/activateAppraisalTypeUnitTestOutput.png}
